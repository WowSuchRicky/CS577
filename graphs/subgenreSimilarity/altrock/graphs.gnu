...
# set terminal wxt 0 size 800, 600
# set output
unset clip points
set clip one
unset clip two
...
unset style line
set style line 1  linetype 1 linecolor 0 linewidth 1.000 pointtype 1 pointsize default pointinterval 0
unset style arrow
...
set my2tics default
set mcbtics default
set xtics border in scale 1,0.5 mirror rotate by -90  offset character 0, 0, 0 autojustify
...
set title "Compression Ratio Using ALTERNATIVE ROCK Encoding" 
...
GNUTERM = "wxt"
plot "ALTERNATIVE ROCK.txt" using 2:xticlabels(1) with histograms
#    EOF
